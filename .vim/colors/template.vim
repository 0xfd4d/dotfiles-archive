...
highlight ColorColumn  term=NONE cterm=NONE ctermfg=10   ctermbg=NONE
...
highlight Cursor       term=NONE cterm=NONE ctermfg=0    ctermbg=7
highlight CursorLine   term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE
highlight DiffAdd      term=NONE cterm=NONE ctermfg=2    ctermbg=0
highlight DiffChange   term=NONE cterm=NONE ctermfg=8    ctermbg=0
highlight DiffDelete   term=NONE cterm=NONE ctermfg=1    ctermbg=0
highlight DiffText     term=NONE cterm=NONE ctermfg=4    ctermbg=0
...
highlight FoldColumn   term=NONE cterm=NONE ctermfg=6    ctermbg=0
highlight Folded       term=NONE cterm=NONE ctermfg=8    ctermbg=0
highlight Function     term=NONE cterm=NONE ctermfg=4    ctermbg=NONE
highlight Identifier   term=NONE cterm=bold ctermfg=1    ctermbg=NONE
highlight IncSearch    term=NONE cterm=bold ctermfg=10   ctermbg=0
...
highlight PreProc      term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
highlight Search       term=NONE cterm=NONE ctermfg=6    ctermbg=NONE
highlight Special      term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
highlight SpecialKey   term=NONE cterm=NONE ctermfg=6    ctermbg=NONE
highlight Statement    term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
...
highlight TabLineSel   term=NONE cterm=NONE ctermfg=7    ctermbg=0
highlight Todo         term=NONE cterm=NONE ctermfg=7    ctermbg=0
...
highlight VertSplit    term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
highlight Visual       term=NONE cterm=NONE ctermfg=0    ctermbg=7
highlight WarningMsg   term=NONE cterm=bold ctermfg=1    ctermbg=NONE
